      ...
      testScript =
        ...
        ''
          ...
          $machine->waitUntilSucceeds(
            "journalctl -u hydra-queue-runner | \
            grep 'preparing InfluxDB notification line'");

          # Check if the InfluxDBNotification plugin uploaded its notification to InfluxDB
          $machine->mustSucceed(
